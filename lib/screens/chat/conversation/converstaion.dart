...
import 'package:shop_app/screens/chat/chats/chat_details.dart';
                        ...
                        children: <Widget>[
                          InkWell(
                            ...
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => ChatDetailPage(name:widget.name,imageUrl: widget.imageUrl)),
                              );
                            } ,
                          ),
